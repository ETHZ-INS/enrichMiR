enrichMiR.ui <- function(){
  ...
  ui <- dashboardPage(
    ...
    dashboardSidebar(width = "300px",
      sidebarMenu(
        menuItem("Collection", tabName="tab_collection"),
        menuItem("Search in\ngene/sequence", 
    ...
    dashboardBody(
      tabItems(
        ...
        tabItem(tabName = "tab_subject",
          tabBox(title="Search bindings in", side="right", id="subjet_type", width=12,
        ...
        tabItem(tabName="tab_mirnas",
          box(width=12,
              column(4, 
                ...
                actionButton("mirnas_conserved", "Selected conserved miRNAs")
                     ),
              column(8, selectizeInput("mirnas", label="Selected miRNAs:", 
